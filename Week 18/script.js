...
const data = `[
  ...
  function createCard({name, universe, alterego, occupation, friends, superpowers, url, info, rating}) {
    ...
    <h2>${name}</h2>
    <div class="wr_rating">
        <i class="wr_rating__star far fa-star"></i>
        <i class="wr_rating__star far fa-star"></i>
        <i class="wr_rating__star far fa-star"></i>
        <i class="wr_rating__star far fa-star"></i>
        <i class="wr_rating__star far fa-star"></i>
    ...
    `
    const ratingStars = [...document.getElementsByClassName("wr_rating__star")];

    function executeRating(stars) {
    const starClassActive = "wr_rating__star fas fa-star";
    const starClassInactive = "wr_rating__star far fa-star";
